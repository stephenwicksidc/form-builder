...
for (var i = 0; i < formData.length; i++) {
  ...
  if (obj.options.length === 0) {
    text = '<input class="fields" type="' + obj.type + '" id="' + obj.id + '" placeholder="' + obj.label +'">'
  } else {
    text = '<input class="fields" options="' + obj.options[0].label +'" type="' + obj.type + '" id="' + obj.id + '" placeholder="' + obj.label +'">'
  }
